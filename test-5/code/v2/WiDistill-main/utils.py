...
def get_dataset(dataset, data_path, batch_size=1, subset="imagenette", args=None):
    ...
    if dataset == 'CIFAR10':
        ...
        #dataset_root = '/mnt/wifi0sensing/MMFi_Dataset/MMFi_Dataset/'
        #config_file = '/mnt/wifi0sensing/MMFi_Dataset/config.yaml'
        dataset_root = '/media/Lab208/New Volume/data/MMFi_Dataset/'
        config_file = '/media/Lab208/New Volume/data/config.yaml'
        ...
        print(f"Number of training samples: {len(dst_train)}")
        print(f"Number of validation samples: {len(dst_test)}")   
        ...
        channel = 22
        im_size = (20,20)
        root = '/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset'
        ...
        # ]
        dst_train = XRFBertDatasetNewMix(file_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/new_data/', text_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/XRF_dataset/', is_train=True, scene='dml')
        dst_test = XRFBertDatasetNewMix(file_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/new_data/', text_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/XRF_dataset/', is_train=False, scene='dml')
        train_loader = torch.utils.data.DataLoader(dataset=XRFBertDatasetNewMix(file_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/new_data/', text_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/XRF_dataset/', is_train=True, scene='dml'), batch_size=64, shuffle=True)
        test_loader = torch.utils.data.DataLoader(dataset=XRFBertDatasetNewMix(file_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/new_data/', text_path='/media/Lab208/Storage Drive/wifi0sensing/MMFi_Dataset/XRF_dataset/', is_train=False, scene='dml'), batch_size=128, shuffle=False)
